...
int servo_calibrate(float degrees){
    int timerMatch;
...
void servo_move(int matchVal){
    TIMER1_TBMATCHR_R = matchVal & 0xFFFF; //set match value
    TIMER1_TBPMR_R = (matchVal >> 16); //set match value
}
